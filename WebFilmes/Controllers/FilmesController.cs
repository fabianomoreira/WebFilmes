    ...
    public class FilmesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Filme != null ? 
                          ...
                          Problem("Entity set 'MvcFilmeContext.Filme'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Price")] Filme filme)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Genre,Price")] Filme filme)
        {
            if (id != filme.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MvcFilmeContext.Filme'  is null.");
            }
            var filme = await _context.Filme.FindAsync(id);
            if (filme != null)
            {
